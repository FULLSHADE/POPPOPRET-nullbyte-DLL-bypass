...
def process_injection():
    ...
    dll_name = "calc.dll"              # process name
...
def drop_DLL_disk():
    ...
    # this function drops a calc.exe .DLL payload generated by msfvenom and B64 encoded
    ...
    try:
        ...
        createF = open('calc.dll', 'wb')
        createF.write(bytes)
        createF.close()
        print("[+] Dropped calc.dll to disk")
    except:
